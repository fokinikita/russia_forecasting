...
----
Чтобы установить себе проект на компьютер: создайте пустую папку и выполните в терминале
...
Если вы хотите получить их в сыром видете, выполните ```python -m main.py```
...
```python -m main.py```, но метрики могут отличаться из-за версий библиотек, хотя random_seed везде зафиксирован
